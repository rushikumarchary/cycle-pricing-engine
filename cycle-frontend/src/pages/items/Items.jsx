...
import UpdateDateTime from "../../components/item/UpdateDateTime";
import UpdatePrice from "../../components/item/UpdatePrice";
import { useLocation, useNavigate } from 'react-router-dom';
import { hasManagementAccess, getAuthHeader, handleApiError, isAuthenticated } from '../../utils/auth';
...
function Items ()  {
  ...
  useEffect(() => {
    const fetchBrands = async () => {
      try {
        const response = await axios.get("http://localhost:8080/brand/brands", getAuthHeader());
