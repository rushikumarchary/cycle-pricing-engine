...
//    }
    ...
    public SecurityFilterChain securityFilterChain(HttpSecurity http) throws Exception {
        return http
                ...
                .csrf(AbstractHttpConfigurer::disable)
                .authorizeHttpRequests(request -> request
                        .requestMatchers("/auth/singUp", "/auth/singIn").permitAll()
...
//        UserDetails adminUser = Users.builder()
//                .username("Admin")
//                .password(passwordEncoder().encode("admin123"))  // Use BCrypt hashing
//                .roles("ADMIN")  // Assign ADMIN role
//                .build();
//
//        UserDetails managerUser = Users.builder()
//                .username("Manager")
//                .password(passwordEncoder().encode("manager123"))  // Use BCrypt hashing
//                .roles("MANAGER")  // Assign MANAGER role
//                .build();
//        UserDetails empUser = Users.builder()
//                .username("Employee")
//                .password(passwordEncoder().encode("employee123"))  // Use BCrypt hashing
//                .roles("EMPLOYEE")  // Assign MANAGER role
//                .build();
//
//        return new InMemoryUserDetailsManager(adminUser, managerUser, empUser);
//    }
