...
class CycleServiceTest {
    ...
    void testGetGroupedItemNameAndTypeByBrandName_BrandNotFound() {
        ...
        Exception exception = assertThrows(BrandNotFound.class, () -> cycleService.getGroupedItemNameAndTypeByBrandName(1));
    ...
    void testGetGroupedItemNameAndTypeByBrandName_NoItemsFound() {
        ...
        Exception exception = assertThrows(ItemNotFound.class, () -> cycleService.getGroupedItemNameAndTypeByBrandName(1));
        System.out.println("Test Passed: " + exception.getMessage());
    }
